...
Rails.application.routes.draw do
    ...
    # Gallery / photo display routes
    scope '/gallery' do
        get '', to: 'photos#gallery', as: :gallery
        post '/search', to: 'photos#search', as: :search_photos
        get '/:id', to: 'photos#show', as: :show_photo
    end

    # Photo download and edit routes
    scope '/photo' do
